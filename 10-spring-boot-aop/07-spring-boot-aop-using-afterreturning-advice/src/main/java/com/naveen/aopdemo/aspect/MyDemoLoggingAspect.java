...
public class MyDemoLoggingAspect {
    ...
    @AfterReturning(pointcut = "com.naveen.aopdemo.aspect.DemoPointcutDeclaration.applytoAllExceptGettersAndSetters()",
    returning = "result")
    private  void displayAfterSuccessfullAccountFindings(JoinPoint theJoinPoint, List<Account> result){
        System.out.println(getClass()+"\n ===>>> Executing AfterReturning order(1)");

        System.out.println("Accounts :"+result);
    }
